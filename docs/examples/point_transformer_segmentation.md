# Point Transformer for 3D Part Segmentation

**Author:** K3-Node Team<br>
**Backend:** Multi-Backend<br>
**Dataset:** `ShapeNet`<br>
**Description:** Point transformer architecture for dense semantic 3D part labeling.

[:simple-googlecolab: **View in Colab**](https://colab.research.google.com/github/anas-rz/k3-node/blob/main/examples/point_transformer_segmentation.ipynb){ .md-button .md-button--primary } &nbsp; [:octicons-mark-github-16: **GitHub source**](https://github.com/anas-rz/k3-node/blob/main/examples/point_transformer_segmentation.ipynb){ .md-button }
...
The following cell contains the original reference implementation from PyG (`pytorch_geometric/examples/point_transformer_segmentation.py`).

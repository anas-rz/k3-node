# Cluster-GCN on PPI Graph Dataset

**Author:** K3-Node Team<br>
**Backend:** Multi-Backend<br>
**Dataset:** `PPI`<br>
**Description:** Scalable training via graph partitioning (Cluster-GCN) on the PPI dataset.

[:simple-googlecolab: **View in Colab**](https://colab.research.google.com/github/anas-rz/k3-node/blob/main/examples/cluster_gcn_ppi.ipynb){ .md-button .md-button--primary } &nbsp; [:octicons-mark-github-16: **GitHub source**](https://github.com/anas-rz/k3-node/blob/main/examples/cluster_gcn_ppi.ipynb){ .md-button }
...
The following cell contains the original reference implementation from PyG (`pytorch_geometric/examples/cluster_gcn_ppi.py`).

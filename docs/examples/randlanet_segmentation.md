...
**Dataset:** `S3DIS / ShapeNet`<br>
**Description:** Real-time semantic segmentation on million-scale 3D point cloud scans.

[:simple-googlecolab: **View in Colab**](https://colab.research.google.com/github/anas-rz/k3-node/blob/main/examples/randlanet_segmentation.ipynb){ .md-button .md-button--primary } &nbsp; [:octicons-mark-github-16: **GitHub source**](https://github.com/anas-rz/k3-node/blob/main/examples/randlanet_segmentation.ipynb){ .md-button }
...
The following cell contains the original reference implementation from PyG (`pytorch_geometric/examples/randlanet_segmentation.py`).
